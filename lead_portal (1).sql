...
CREATE TABLE `lead_data` (
  ...
  `disposition_l` varchar(255) DEFAULT NULL,
...
INSERT INTO `lead_data` (`id`, `contact_number`, `first_name`, `last_name`, `phone`, `phone2`, `client`, `loan_officer`, `Address`, `Zip`, `State`, `City`, `Address2`, `Zip2`, `State2`, `City2`, `total_loan`, `interest_rate`, `rate_type`, `loan_type`, `house_type`, `property_usage`, `interest2`, `rate_type2`, `credit_card_dept`, `late_payment`, `cashout`, `foreclosure`, `Bankrupcy`, `employement_status`, `comments`, `disposition_l`, `submitted_by`, `sale_date`, `created_at`) VALUES
(18, '03004561234', 'John', ' Smith', '2147483647', '', 'Mortgage', 'Officer A', '123 Main Street', '', 'Punjab', 'Karachi', '123 Main Street', '', 'Punjab', 'Karachi', 2500000, 9, 'Fixed', 'Refinance', 'Single', 'Primary Usage', '', '', '', '', '', '', '', 'Employed', '', 'DNC', 8, '2025-11-13 23:40:50', '2025-11-13 23:40:50'),
(19, '03007895612', 'Smith', 'Khan', '03007895612', '123456789', 'DAA', 'Officer B', '45 Garden Avenue', '', 'Sindh', 'Karachi', '123 Main Street', '', 'Punjab', '0', 3500000, 8, 'Adjustable', 'Purchase', 'Single', 'Primary Usage', '', '', '', '', '', '', '', 'Employed', 'Done', '0', 8, '2025-11-14 00:13:53', '2025-11-14 00:13:53');
...
(10, 'CSR1', '$2y$10$A5X1CVMbXdWum18HbDeWvOObAAJyErPISHf0cBn/4QokWh2DKi1ja', NULL, 4, 0, '2025-11-07 18:46:08'),
(13, 'CSR3', '$2y$10$A5X1CVMbXdWum18HbDeWvOObAAJyErPISHf0cBn/4QokWh2DKi1ja', NULL, 4, 0, '2025-11-07 22:26:31'),
(14, 'CSR4', '$2y$10$A5X1CVMbXdWum18HbDeWvOObAAJyErPISHf0cBn/4QokWh2DKi1ja', NULL, 4, 0, '2025-11-07 22:29:53'),
(15, 'CSR2', '$2y$10$A5X1CVMbXdWum18HbDeWvOObAAJyErPISHf0cBn/4QokWh2DKi1ja', NULL, 4, 0, '2025-11-11 17:55:26'),
(16, 'Hamza', '$2y$10$A5X1CVMbXdWum18HbDeWvOObAAJyErPISHf0cBn/4QokWh2DKi1ja', NULL, 4, 0, '2025-11-12 23:39:33');
